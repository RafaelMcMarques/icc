...
#define UF 4  /* Fator de unroll */
#define BK 4 /* Fator de blocking */
...
void multMatVet_opt (MatRow mat, Vetor v, int m, int n, Vetor res);

void multMatMat(MatRow A, MatRow B, int n, MatRow C);

void multMatMat_opt(MatRow A, MatRow B, int n, MatRow C);
