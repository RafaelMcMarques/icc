...
static inline always intervaloDouble soma(intervaloDouble x, intervaloDouble y) {
...
static inline always intervaloDouble subtrai(intervaloDouble x, intervaloDouble y) {
    intervaloDouble result;
...
static inline always intervaloDouble multiplica(intervaloDouble x , intervaloDouble y) {
    intervaloDouble result;
...
static inline always intervaloDouble divide(intervaloDouble x, intervaloDouble y) {
    intervaloDouble result;
...
static inline always intervaloDouble potenciaInteira(intervaloDouble x, int p) {
    intervaloDouble result;
...
static inline always void lerIntervalo(intervaloDouble *x) {
    fesetround(FE_DOWNWARD);
    scanf("%lf", &x->min);
    x->max = nextafter(x->min, INFINITY);
}

static inline always void imprimirIntervalo(intervaloDouble x) {
